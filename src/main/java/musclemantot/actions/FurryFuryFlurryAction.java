...
public class FurryFuryFlurryAction extends AbstractGameAction {
    ...
    public FurryFuryFlurryAction(AbstractPlayer p, AbstractMonster m, int damage, DamageInfo.DamageType damageTypeForTurn, boolean freeToPlayOnce, int energyOnUse) {
        this.p = p;
        this.m = m;
        this.damage = damage;
