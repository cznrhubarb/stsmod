package musclemantot.characters;
...
import static musclemantot.MuscleManTotMod.characterPath;
import static musclemantot.MuscleManTotMod.makeID;

public class MuscleManTot extends CustomPlayer {
    //Stats
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass MUSCLE_MAN_TOT;
        @SpireEnum(name = "MUSCLE_MAN_TOT_BROWN_COLOR") // These two MUST match. Change it to something unique for your character.
    ...
    private final Color cardRenderColor = Color.FIREBRICK.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.FIREBRICK.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = Color.FIREBRICK.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
