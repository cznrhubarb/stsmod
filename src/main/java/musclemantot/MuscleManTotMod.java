...
public class MuscleManTotMod implements
    ...
    private static final String resourcesFolder = "musclemantot";

    private static final String CHAR_SELECT_BUTTON = characterPath("select/button.png");
    private static final String CHAR_SELECT_PORTRAIT = characterPath("select/portrait.png");

    public static final Color CARD_COLOR = new Color(200f/255, 177f/255, 139f/255, 1);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(
            ...
            CARD_COLOR,
            cardbackPath("bg_attack.png"),
            cardbackPath("bg_skill.png"),
            cardbackPath("bg_power.png"),
            cardbackPath("energy_orb.png"),
            cardbackPath("bg_attack_p.png"),
            cardbackPath("bg_skill_p.png"),
            cardbackPath("bg_power_p.png"),
            cardbackPath("energy_orb_p.png"),
            cardbackPath("small_orb.png")
        );
    }

    public MuscleManTotMod() {
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(
                ...
                MuscleManTot.Enums.MUSCLE_MAN_TOT
        );
    }
...
//                  }
    ...
    public static String cardbackPath(String file) {
        return characterPath("cardback") + "/" + file;
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(MuscleManTotMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
