...
import static musclemantot.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    MuscleManTotMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
